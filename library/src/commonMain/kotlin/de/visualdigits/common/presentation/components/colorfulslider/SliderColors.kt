package de.visualdigits.common.presentation.components.colorfulslider
...
import de.visualdigits.common.presentation.components.colorfulslider.ui.ActiveTrackColor
import de.visualdigits.common.presentation.components.colorfulslider.ui.InactiveTrackColor
import de.visualdigits.common.presentation.components.colorfulslider.ui.ThumbColor
...
object MaterialSliderDefaults {
    ...
    private fun activeTickSolidColor(color: SliderBrushColor) =
        SliderDefaults.colors().activeTickColor

    @Composable
    private fun inActiveTickSolidColor(color: SliderBrushColor) =
        SliderDefaults.colors().inactiveTickColor

    @Composable
    private fun disabledActiveTickSolidColor(color: SliderBrushColor) =
        SliderDefaults.colors().disabledInactiveTickColor
