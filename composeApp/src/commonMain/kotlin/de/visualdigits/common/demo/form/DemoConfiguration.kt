...
class DemoConfiguration(
    fields: LinkedHashMap<DC, Field<*,*,DC>> = LinkedHashMap()
): AbstractConfiguration<DemoConfiguration, DC>(fields) {
    ...
    override fun createInstance(newFields: LinkedHashMap<DC, Field<*,*,DC>>): DemoConfiguration {
